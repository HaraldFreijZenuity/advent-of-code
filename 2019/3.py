...
for wire in [wire_1,wire_2]:
    ...
    for instruction in wire:
        ...
        if direction_letter == "R":
            ...
            print("Problem! Illegal direction {}!".format(instruction))
            exit
print("Grid from ({}, {}) to ({}, {})".format(x_min,y_min,x_max,y_max))
x_size=x_max-x_min+1
y_size=y_max-y_min+1
distance_mx=numpy.ndarray((x_size,y_size))
distance_mx.fill(float('inf'))
x=-x_min
y=-y_min
d=0
...
for instruction in wire_2:
    ...
    for i in range(length):
        ...
        if direction_letter == "R":
            ...
            y-=1
        min_distance=min(min_distance,d+distance_mx[x,y])
